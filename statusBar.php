...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <?php
        if(isset($_COOKIE['passed'])){
          echo "<div style='text-align:right;margin-right:5px'><button class='btn btn-outline-primary' onclick='logOut()' style='margin-right:5px'>登出</button><button class='btn btn-outline-primary' onclick='redirectMember()'>會員中心</button></div>";
            }else{
